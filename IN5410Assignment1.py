...
if __name__ == "__main__":
    ...
    myHouse.elAppliences.append(ElApplience("Dishwasher", 1.44, 1.44, 1))
    myHouse.elAppliences.append(ElApplience("EV", 9.9, 9.9, 3))
    myHouse.elAppliences.append(ElApplience("WashingMachine", 1.94, 1.94, 1))
